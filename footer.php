		<footer class="footer mt-auto py-3 bg-dark w-100 py-4 flex-shrink-0">
				...
				<div class="row gy-4">
						...
						<div class="col-lg-2 col-md-6">
							...
							<ul class="list-unstyled text-muted">
								...
								<li><a href="download-wallet">Get started</a></li>
						...
						<div class="col-lg-4 col-md-6">
							...
							<form action="subscribe" method="post">
								<div class="input-group mb-3">
									<input class="form-control" type="email" name="email" id="email" placeholder="Your e-mail address" aria-label="Your e-mail address" aria-describedby="button-addon2">
									<button type="submit" class="btn btn-primary" id="button-addon2" type="button"><i class="fas fa-paper-plane"></i></button>
								</div>
							</form>
						</div>
					</div>
